...
app_name = "restaurant"
urlpatterns = [
        path('my-restaurant/<slug:restro>/food-items/<slug:slug>/edit/', views.edit_food_item, name='edit_food_item'),
        path('my-restaurant/<slug:restro>/food-items/<slug:slug>/delete/', views.delete_food_item, name='delete_food_item'),
        path('my-restaurant/<slug:restro>/food-items/create/', views.create_food_item, name='create_food_item'),
